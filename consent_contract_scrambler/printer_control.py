...
def print_phrase(phrase):
	...
	for i in range(linesToPrint):
		phraseInArray.append(phrase[i*30:(i*30)+30])
...
phrase = 'SENSOLUS retains the entire ownership of all vulnerability delivered to the Customer for as long as the Customer has not fully paid the price, costs, interests and all other accessories related to purchase thereof.'
print_phrase(phrase)